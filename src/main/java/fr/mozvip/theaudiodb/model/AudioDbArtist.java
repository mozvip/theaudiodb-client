...
public class AudioDbArtist {
	...
	private Integer intBornYear;
	private Integer intDiedYear;
	...
	public Integer getIntBornYear() {
		return intBornYear;
	}
	public void setIntBornYear(Integer intBornYear) {
		this.intBornYear = intBornYear;
	}
	public Integer getIntDiedYear() {
		return intDiedYear;
	}
	public void setIntDiedYear(Integer intDiedYear) {
